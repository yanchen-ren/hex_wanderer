...
- 道具效果全部实现：npcFriendly, combatNoDamageOnWin, combatSurrenderChance, ruinLootUpgrade, luckModifier, trapImmunity, bribe, scare(稻草人/气球), beast_flute, earphone hint
...
- `update-project-status` — agentStop 时自动更新 STATUS.md
